...
explicado. Es una buena guía para empezar desde 0 y la *temática* lo hace más **agradable y divertido**.
...
También nos resultó fácil el hecho de ser un **lenguaje comprensivo**, es decir que todo se puede modificar mientras el programa esté corriendo
(o sea usando la consola).

3) Entender qué realizaban algunas funciones que no conociamos, y acostumbrarnos a la sintaxis. 

4) Funciones, variables, estructuras, ciclos, lo básico para saber programar.
